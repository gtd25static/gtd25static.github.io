...
function ListItem({ list, selected, onSelect, highlight, focused }: {
  ...
  return (
    <div data-focus-id={list.id} className="group flex items-center">
      <button
        onClick={onSelect}
        className={`flex flex-1 items-center gap-3 rounded-full px-3 py-2 text-sm transition-colors ${
          focused
      ...
      <nav className="flex-1 overflow-y-auto px-2 pt-1 scrollbar-thin">
        ...
        {creating ? (
          <form
            ...
            className="mx-2 mt-1 space-y-2 rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-700 dark:bg-zinc-800"
          >
            <Input
