...
- **ON:** local content + credentials are encrypted at rest behind the vault
  ...
  would still be ciphertext). An idle/lock screen gates access; failed-attempt and panic wipes exist.
