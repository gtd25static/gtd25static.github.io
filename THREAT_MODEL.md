...
- **Paranoid ON + UNLOCKED — 🔴.** While unlocked, the **DEK**, decrypted data,
  ...
  unlocked in the last 24 h), so this unlocked window can reach twice your configured
