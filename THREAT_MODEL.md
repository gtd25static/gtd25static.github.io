...
- `taskList.name`; `task.title/description/link/linkTitle/links/discussionLog`;
  ...
  and `mindmapFolder.name` / `mindmap.name` / `mindmapNode.label` +
  `mindmapNode.shape/palette/colorBg/colorFg/colorBorder` (Mindmaps — see below).
