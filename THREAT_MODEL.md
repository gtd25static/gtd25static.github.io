...
- **Checking without using it (added 2026-09-22):** Settings → *Secondary
  ...
  (same salt + KDF, slot 1 then slot 2, untrimmed) — and stops there: no unlock,
